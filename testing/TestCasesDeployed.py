...
class Test(unittest.TestCase):
    ...
    def setUp(self):
        cfg=dict()
        cfg['host']='142.104.17.141'
        cfg['http_port']=8000
        cfg['ws_port']=8001
        #cfg['protocol']='http'
        self.ws_api = PubSub_WS_API(cfg)
        self.ws_api_sub = PubSub_WS_API(cfg)
        self.http_api = PubSub_HTTP_API(cfg)
    ...
    def testSendMessageWS_Pub_WS_Sub(self):
        print "Test Send Message WS to WS"
        pub_id = self.ws_api.createPublisher()
